...
/** RUTA DE PRODUCTOS **/
Route::middleware(['auth'])->group(function () {
//    Route::get('/productos/propiedades/eliminar/{id}', 'ProductosController@delete')->name('eliminarpropiedad');
//    Route::get('/productos/propiedades/toogle/{id}/{estado}', 'ProductosController@toogle')->name('tooglepropiedad');
    Route::post('/productos/agregar', 'ProductosController@store')->name('agregarproducto');
    Route::put('/productos/propiedades/editar/{id}', 'ProductosController@update')->name('editarpropiedad');
});
/** RUTA DE PRODUCTOS **/
/** RUTAS DE PRODUCTOS Y PROPIEDADES **/
