        ...
        <form action="/codliveditor/configuracion/1" method="post">
            ...
            <div>
                <div class="form-group">
                    ...
                    <select name="tipostorage" class="form-control" id="tipostorage">
            ...
            <div>
                <div class="form-group">
                    ...
                    <select name="tiporender" class="form-control" id="tiporender">
            ...
            <div>
                <div class="form-group">
                    ...
                    <select name="tipoframework" class="form-control" id="tipoframework">
