    ...
    <script>
        ...
        function cambiodeprecios(idselect, produ) {
            ...
            fetch('/buscar/propiedad/producto/id', {
                ...
                .then(response => {
                    console.log(response);
                    document.getElementById('preciounitario' + produ).value = "2";
                });
        }
